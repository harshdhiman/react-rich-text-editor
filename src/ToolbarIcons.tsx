...
export const MediaAttachmentIcon: React.FC<IconProps> = ({
  color = "#fff",
  size = 20,
}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
    <path d="M19 5H5c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 12H5l3.5-4.5 2.5 3.01L14.5 11 19 17zm-9-6.5c0 .83-.67 1.5-1.5 1.5S7 11.33 7 10.5 7.67 9 8.5 9s1.5.67 1.5 1.5z" />
  </svg>
);
