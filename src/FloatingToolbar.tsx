...
const isOptionActive = (option: ToolbarOption, styles: ActiveStylesState): boolean => {
  switch (option) {
    ...
    case 'highlight': return styles.highlight;
    case 'heading': return styles.blockType === 'heading';
    case 'bullet': return styles.blockType === 'bullet';
    case 'numbered': return styles.blockType === 'numbered';
    case 'quote': return styles.blockType === 'quote';
    case 'checklist': return styles.blockType === 'checklist';
    case 'alignLeft': return styles.alignment === 'left';
    case 'alignCenter': return styles.alignment === 'center';
    case 'alignRight': return styles.alignment === 'right';
...
export const FloatingToolbar: React.FC<FloatingToolbarProps> = ({
  ...
  const handleButtonMouseDown = useCallback((e: React.MouseEvent, action: ToolbarOption) => {
    e.preventDefault();
    e.stopPropagation();
    onAction(action);
  }, [onAction]);
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: BUTTON_SPACING }}>
          {options.map((option) => {
